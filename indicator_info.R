...
indicator_scoring_details <- list(
  ...
  "Civil Society Participation Role in Wholesale Regional Market (M)" =
    "1.0: Open membership (MISO, CAISO).<br>0.66: Limited voting participation (ISO-NE, SPP).<br>0.33: Non-voting participation (PJM).<br>0.0: Not in RTO/ISO.<br>Weighted averages applied for states spanning multiple markets.",
  
  "State Authority Role in Wholesale Regional Market (M)" =
    "1.0: Statutory (CAISO, ERCOT).<br>0.66: Delegated (MISO, SPP).<br>0.33: Advisory (ISO-NE, NYISO, PJM).<br>0.0: No formal role or not in market.<br>Scores weighted by customer share across markets."
)
...
# -----------------------------------------------
# GLOBAL CUSTOM GGLOT THEME FOR DASHBOARD PLOTS
# -----------------------------------------------
pacman::p_load(ggplot2, showtext)

# Load Google Roboto for ggplot 
...
# Custom plot theme for indicator bar chart
